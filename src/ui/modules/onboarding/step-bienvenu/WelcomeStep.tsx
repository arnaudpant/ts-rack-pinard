        ...
        <div className="h-[calc(100vh-64px)]">
            ...
            <div className="relative h-[calc(100vh-102px)] md:h-[calc(100vh-130px)] flex flex-col items-start md:flex-row">
                <div className="md:w-2/3">
                    <h1 className="text-2xl text-center md:text-5xl md:text-left pt-5 px-6">Bienvenue sur "Racks à Pinard" !</h1>
                    <p className="px-6 pt-6 md:text-xl">Marre d'acheter du vin et de perdre ton temps dans ta cave pour retrouver LA bouteille que tu veux boire ?</p>
                    <p className="px-6 pt-3 md:text-xl">Gère tes bouteilles et
