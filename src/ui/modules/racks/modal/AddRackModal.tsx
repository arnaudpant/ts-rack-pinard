    ...
    return createPortal(
        <div className="absolute w-72 bg-vin100 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl flex flex-col items-center shadow-xl">
            ...
            <form className="flex flex-col gap-1">
                ...
                <input type="text" id="rackName" name="rackName" placeholder="Donnez un nom au rack" className="p-2 rounded-md mb-2 bg-fond text-sm" />
                
                <label htmlFor="colonnes">Entrez le nombre de colonnes</label>
                <input type="number" id="colonnes" name="colonnes" placeholder="Nombre de colonnes" className="p-2 rounded-md mb-2 bg-fond text-sm" />
                
                <label htmlFor="rangees">Entrez le nombre de rangées</label>
                <input type="number" id="rangees" name="rangees" placeholder="Nombre de rangées" className="p-2 rounded-md mb-2 bg-fond text-sm" />
