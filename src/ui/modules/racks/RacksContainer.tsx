        ...
        <>
            {
                authUser.userDocument.racks.length === 0 ? (
                    <div className="flex flex-col items-center gap-4 px-2">
                        <h2 className="text-2xl md:text-3xl text-center">Bienvenu dans votre cave à vin !</h2>
                        <h3 className="text-lg md:text-xl text-center">Il semblerait que vous n'ayez pas encore de racks à pinard</h3>
