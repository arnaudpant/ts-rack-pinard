...
const Header: React.FC = () => {
    ...
    return (
        <header className="relative flex items-center justify-center h-16 bg-vin text-fond ">
            ...
            <div className={clsx(!authUser && `hidden`, 'absolute right-4 cursor-pointer w-14 h-14')}>
                {
                    scrAvatar == "" ? (<Avatar src="/bottle.svg" width="14" height="14"/>) : (<Avatar src={scrAvatar} width="14" height="14"/>)                   
                }
            </div>
